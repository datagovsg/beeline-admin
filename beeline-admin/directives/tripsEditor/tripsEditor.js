    ...
    link(scope, elem, attr) {
      ...
      scope.refreshTrips = function() {
        var promise = TripsService.getTrips({
          routeId: scope.routeId,
          startDate: new Date(scope.filter.startDate) - 8*60*60*1000 /* timezone offset */,
          endDate: new Date(new Date(scope.filter.startDate).getTime() + 60 * 24 * 60 * 60 * 1000 - 8*60*60*1000 /* timezone offset */),
