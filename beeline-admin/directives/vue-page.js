...
Vue.component('CompaniesPage', require('../../beeline-admin/pages/companies.vue').default)
Vue.component('ContactListPage', require('../../beeline-admin/pages/contact-list.vue').default)
Vue.component('ContactListsPage', require('../../beeline-admin/pages/contact-lists.vue').default)
