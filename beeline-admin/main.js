...
require('./controllers/telephoneListController')
require('./controllers/telephoneListsController')
require('./controllers/crowdstartSummary')
require('./directives/promoEditor/criterionEditor')
require('./directives/selectors/telephoneList')
...
.service('issueRouteCreditsModal', require('./services/issueRouteCreditsModal').default)
